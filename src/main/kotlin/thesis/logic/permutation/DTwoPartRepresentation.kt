...
data class DTwoPartRepresentation(
...
) : IPermutation<DTwoPartRepresentation.Factory> {

    class Factory : IPermutation.IFactory {
        override fun produce(values: Array<IntArray>) = DTwoPartRepresentation(values)
    }
    ...
    override fun copy(): DTwoPartRepresentation {
